...
insert into portfolios (title, content, github_link, tech_stack) values (
  ...
  ['MySQL', 'MongoDB', 'NodeJS', 'ReactJS', 'Nginx']
)
...
insert into portfolios (title, content, github_link, tech_stack) values (
  ...
  ['Spring Boot', 'Fastify', 'Flask', 'Docker', 'CI/CD', 'DevOps', 'ReactJS']
)
...
insert into portfolios (title, content, github_link, tech_stack) values (
  ...
  ['Web Assembly', 'Express', 'React', 'CLI 개발', 'Package 개발, 배포']
)
...
insert into portfolios (title, content, github_link, tech_stack) values (
  ...
  ['k8s', 'Docker', 'Event-Bus', 'Skaffold', 'Helmet', 'Fastify', 'React']
)
...
insert into portfolios (title, content, github_link, tech_stack) values (
  ...
  ['GCP', 'Linux', 'MariaDB', 'WSGI', 'Python', 'Apache2']
)
