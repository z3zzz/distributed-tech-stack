...
function Postman() {
  ...
  const { method, uri, body, language, db, server } = useSelector(
    (state) => state.field
  );
    ...
    <>
      ...
      <div className="flex mt-10">
        <h2 className="text-3xl font-bold font-inter text-left block flex-1">
          Response{' '}
          <span className="text-sm text-gray-400 font-medium"> (0.5s)</span>{' '}
        </h2>
        <span className="text-sm text-gray-400 font-medium block pt-4">
          Status: &nbsp;
        </span>
        <span className="text-sm text-green-500 font-medium block pt-4">
          {' '}
          200 &nbsp;ok
        </span>
      </div>
          ...
          <div className="space-y-8 mb-8">
            <div className="text-gray-500 space-y-3">
              ...
              <p>
                ...
                team on discovery, helping to assess the direction and
